# [Generated App](https://app-generator.dev/tools/django-generator/) sample 

Starter built with [Django App Generator](https://app-generator.dev/tools/django-generator/) (an open-source service) using Tabler design.
In order to use the sources, follow the build instructions as presented in `Start with Docker` and `Manual Build` sections. 

> [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-tabler-1734218330) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-tabler-1734218330.git
$ cd django-tabler-1734218330
```
...
---
sample Django Starter built with [Django App Generator](https://app-generator.dev/tools/django-generator/) - open-source service for developers.
